...
**Status: LAUNCHED** — OSS marketing visible when `NEXT_PUBLIC_OSS_LAUNCHED=true` on production.
...
All engineering blockers cleared 2026-08-26. Operator-only items (provider dashboard secret rotation, legal counsel sign-off) documented in RELEASE.md.

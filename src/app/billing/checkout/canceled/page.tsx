...
export default async function CheckoutCanceledPage({
  ...
  return (
    <div className="fj-checkout-card">
      <h1 className="fj-checkout-card__title">Checkout canceled</h1>
      <p className="fj-checkout-card__lede">
        No charge was completed and your current plan is unchanged. You can pick
        a plan whenever you are ready.
      </p>

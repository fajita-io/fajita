...
export default async function Page() {
  return (
    <>
      ...
      <OpsPageHeader
        title={"Refund review"}
        deck={"Refund requests and approval state. Execution stays in Stripe unless implemented."}
        actions={
          <>
      ...
      <OpsPanel title="Status">
        <OpsEmpty>
          ...
          attention list when action is required. Route: /internal/revenue/refunds
        </OpsEmpty>
      </OpsPanel>
    </>
  );

...
/** Customer-facing copy when live Checkout cannot charge yet. */
export function stripePaymentsUnavailableMessage(): string {
  return "Card payments are still activating on our billing account. Stripe is finishing review (usually a few business days). Continue into Fajita for now. We will email you when checkout is live.";
}

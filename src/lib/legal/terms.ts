    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '"Service Level Agreement" or "SLA" means the availability and service credit terms at /legal/sla, as updated from time to time.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Entire agreement. These Terms, together with the Privacy Policy, Acceptable Use Policy, Cookie Notice, Refund Policy, Service Level Agreement, and any plan-specific terms presented at checkout, constitute the entire agreement regarding the Service and supersede prior or contemporaneous understandings on that subject.",

...
export function buildGoLiveApproval(): GoLiveApproval {
  ...
  return {
    ...
    conditions: [
      "Stage 0 soft launch: founder verification traffic OK.",
      "Set Sentry DSN via npm run wire:sentry before Stage 1.",
      "Enable Supabase PITR on Pro when customer volume warrants it.",
      "Run browser login smoke before Stage 2 public signup.",

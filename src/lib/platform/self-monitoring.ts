/**
 * Fajita-on-Fajita monitoring definitions for launch readiness.
 * Operators create these monitors in the internal fixture organization.
 * Circular-only monitoring is insufficient; keep at least one external check
 * (documented in docs/operations/fajita-self-monitoring.md).
 */
...
export const FAJITA_STATUS_COMPONENTS = [
  ...
  { key: "billing", name: "Billing", description: "Checkout and Stripe webhooks" },
  {
    key: "support_chat",
    name: "Support chat",
    description: "Ask Fajita / Pamphlet path",
  },
] as const;

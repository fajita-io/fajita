/**
 * Customer referral foundation. Distinct from Phase 12 affiliate commissions.
 * Default reward: none / thank-you / optional affiliate invite after qualification.
 * No cash credits without an approved credit ledger.
 */
...
/**
 * Resolve referral vs affiliate attribution.
 * Locked affiliate attribution remains authoritative for commissions.
 * Historical unpaid referrals do not become commissions when advocate joins affiliates.
 */
export function resolveAttributionConflict(input: {
  ...
  if (input.affiliateLocked) {
    return {
      ...
      note: "Phase 12 affiliate attribution is locked; referral does not create a commission",
    };
  }
